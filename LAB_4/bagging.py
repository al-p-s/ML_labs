...
# Загрузка
df = pd.read_csv('z_datasets/glass.csv')
...
for name, base_clf in base_classifiers.items():
    ...
    for n_est in n_estimators_range:
        ...
        train_acc = accuracy_score(y_train, bagging.predict(X_train))
...
fig.suptitle('Зависимость точности от количества классификаторов в бэггинге', fontsize=16)
